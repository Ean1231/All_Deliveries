...
@Component({
  ...
  templateUrl: './contractor-register.page.html',
  styleUrls: ['./contractor-register.page.scss'],
})
export class ContractorRegisterPage implements OnInit {
  phoneNumber: number;
  password: any;
  displayName: any;
privacy: string ;
  ...
  ngOnInit() {
    this.signupForm = new FormGroup({
      ...
      'contractor_address': new FormControl('', Validators.required),
      ...
      'next_of_kin_name': new FormControl('', Validators.required),
      'next_of_kin_surname': new FormControl('', Validators.required),
      ...
      'next_of_kin_contact': new FormControl('', [Validators.required, Validators.pattern("^((\\+27-?)|0)?[0-9]{10}$")]),
      'background_check': new FormControl('', Validators.required),
  ...
  signup(){
    ...
    this.authService.RegisterContractor(this.signupForm.value)
    .then((result) => {
